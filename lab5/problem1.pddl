(define (problem dynamic1)
    ...
    (:init
        ...
        (at orange POS5_1)
        (at yellow POS4_4)
        (empty POS1_1)(empty POS2_1)(empty POS3_1)(empty POS4_1)
        (empty POS1_2)(empty POS2_2)(empty POS4_2)(empty POS5_2)
        (empty POS1_3)(empty POS3_3)(empty POS4_3)(empty POS5_3)
        (empty POS1_4)(empty POS2_4)(empty POS3_4)(empty POS5_4)
        (empty POS1_5)(empty POS2_5)(empty POS3_5)(empty POS4_5)
        (static)
        (= (moves) 0)
